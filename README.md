...
<body class="gradient-bg min-h-screen">
    <div class="container mx-auto px-4 py-8 max-w-4xl text-white">
        ...
        <!-- About Section -->
        <section id="about" class="mb-12 bg-gray-900 rounded-xl p-6 shadow-md" data-aos="fade-up">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    <p class="text-gray-300 mb-4">
                        I am an Economics and Finance graduate with hands-on experience at <span class="font-semibold text-blue-400">NSSF Kenya</span> and the <span class="font-semibold text-blue-400">National Treasury – Nyeri Central</span>.
                    </p>
        ...
        <!-- Skills Section -->
        <section class="mb-12 bg-gray-900 rounded-xl p-6 shadow-md" data-aos="fade-up">
            <h2 class="text-2xl font-bold text-white mb-4 flex items-center">
                <span class="emoji">🔹</span> Skills
            </h2>
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    <h3 class="text-lg font-semibold text-gray-300 mb-2 flex items-center">
        ...
        <section id="projects" class="mb-12" data-aos="fade-up">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-gray-900 rounded-xl p-6 shadow-md card-hover transition duration-300">
                    ...
                    <p class="text-gray-300 mb-4">Policy and economic evaluation of housing program</p>
                ...
                <div class="bg-gray-900 rounded-xl p-6 shadow-md card-hover transition duration-300">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-white">Recover Deleted Photos</h3>
                    </div>
                    <p class="text-gray-300 mb-4">Lost Past</p>
                    <a href="https://mwanikijames.github.io/recoverdeletedphotos/" class="text-blue-500 hover:text-blue-700 flex items-center">
                        <i data-feather="github" class="mr-2"></i> View Project
                    </a>
                </div>
                <!-- Project 4 -->
                ...
                <div class="bg-gray-900 rounded-xl p-6 shadow-md card-hover transition duration-300">
                    ...
                    <p class="text-gray-300 mb-4">Pension/benefits simulation</p>
                    <a href="https://mwanikijames.github.io/NSSF-Benefits-Calculator/" class="text-blue-500 hover:text-blue-700 flex items-center">
                        <i data-feather="github" class="mr-2"></i> View Project
                    </a>
                </div>
            </div>
        ...
        <section class="mb-12 bg-gray-900 rounded-xl p-6 shadow-md" data-aos="fade-up">
            ...
            <div class="space-y-6">
                <div>
                    <h3 class="text-lg font-semibold text-white">NSSF Kenya</h3>
                ...
                <div>
                    <h3 class="text-lg font-semibold text-white">National Treasury – Nyeri Central (Attachment)</h3>
                    <ul class="list-disc pl-5 text-gray-300 space-y-1 mt-2">
        ...
        <section class="mb-12 bg-gray-900 rounded-xl p-6 shadow-md" data-aos="fade-up">
            ...
            <div class="space-y-4">
                <div>
                    <h3 class="text-lg font-semibold text-white">Kirinyaga University</h3>
                    <p class="text-gray-300">BSc. Economics & Finance</p>
                </div>
                <div>
                    <h3 class="text-lg font-semibold text-white">Kenyatta High School</h3>
                    <p class="text-gray-300">B- (KCSE)</p>
                </div>
                <div>
                    <h3 class="text-lg font-semibold text-white">Kirini Primary School</h3>
                    <p class="text-gray-300">361 Marks (KCPE)</p>
                </div>
            </div>
        </section>

        <!-- Contact Section -->
        <section id="contact" class="mb-12 bg-gray-900 rounded-xl p-6 shadow-md text-center" data-aos="fade-up">
        ...
        <footer class="text-center py-6" data-aos="fade-up">
            <p class="text-gray-300 italic">⭐️ "Always learning, always building – with data, finance, and impact in mind."</p>
        </footer>
    </div>
